...
namespace NetCoreConcepts
{
    public class Startup
    {
        ...
        {
            services.AddScoped<TestModelNew, TestModelNew>();
            //services.AddHttpClient("CompaniesClient", config =>
            //{
            //    config.BaseAddress = new Uri("https://localhost:44393/api/");
            ...
            services.AddDbContext<RepositoryContext>(options =>
                options.UseSqlServer(Configuration.GetConnectionString("ProjectManagement")));
